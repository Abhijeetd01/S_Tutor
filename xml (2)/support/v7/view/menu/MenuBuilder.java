    ...
    do
    {
      do
      {
        ...
        do
        {
          ...
          localActionProvider = localMenuItemImpl.getSupportActionProvider();
          i = 0;
          if (localActionProvider != null)
          {
            boolean bool2 = localActionProvider.hasSubMenu();
            i = 0;
            if (bool2) {
              i = 1;
            }
        ...
        bool1 |= dispatchSubMenuSelected(localSubMenuBuilder, paramMenuPresenter);
      } while (bool1);
      close(true);
      return bool1;
