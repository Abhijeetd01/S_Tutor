...
LinearLayoutCompat
  ...
  LinearLayoutCompat, , 
    ...
    , , 
     = obtainStyledAttributes, , LinearLayoutCompat, , 0
     = getIntLinearLayoutCompat_android_orientation, -1
     (>=0 {
      setOrientation
    
     = getIntLinearLayoutCompat_android_gravity, -1
     (>=0 {
      setGravity
    
     = getBooleanLinearLayoutCompat_android_baselineAligned, 
     ( {
      setBaselineAligned
  ...
  public int getBaseline()
  {
    ...
    for (;;)
    {
      return j + (k + ((LinearLayoutCompat.LayoutParams)localView.getLayoutParams()).topMargin);
