...
Appyscript.hyperListing = function(a, catId, categoryName, isSortHyperlocal) {
    ...
    var urr = '{"method":"getListingWithSubCategory","appId":"' + localStorage.getItem("appid") + '","pageIdentifier":"' + pageIdentifie + '","catId":"' + catId + '","isSortHyperlocal":"' + isSortHyperlocal + '","sortCatAlpha":"' + AppyTemplate.global.setting.categoryAlphaSorting + '"}';
...
AppyTemplate.registerPartial('hyperLocalSubListingListing', '<li id="serviceinnerSubHeaderPage" class="listing-item" >' +
...
AppyTemplate.registerPartial('hyperListing', '<li id="serviceinnerSubHeaderPage"  class="listing-item" >' +
...
Appyscript.createHyperlisting = function(a, subcatId, subcatname, isSortHyperlocal) {
    ...
    var urr = '{"method":"getListingWithSubCategory","appId":"' + localStorage.getItem("appid") + '","pageIdentifier":"' + pageIdentifie + '","catId":"' + subcatId + '","isSortHyperlocal":"' + isSortHyperlocal + '","sortCatAlpha":"' + AppyTemplate.global.setting.categoryAlphaSorting + '"}';
...
function showValueHyperlocalPrice() {
    $$("#hyperPriceValue1").html($$("#hyperlocalPriceMin").val() + pageData.setting.currency);
    $$("#hyperPriceValue2").html($$("#hyperlocalPriceMax").val() + pageData.setting.currency);
}
...
function _getWeatherAddressHyperLocal(data) {
